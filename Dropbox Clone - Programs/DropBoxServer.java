...
public class DropBoxServer extends Thread {
   ...
   public DropBoxServer(int port) throws IOException {
   ...
   public void run() {
      while(true) {
         try {
            ...
            System.out.println("Just connected to DropBox Server at" + server.getRemoteSocketAddress());
            in = new DataInputStream(server.getInputStream());
            
            System.out.println(in.readUTF());
            out = new DataOutputStream(server.getOutputStream());
            out.writeUTF("Thank you for connecting to DropBox Server at " + server.getLocalSocketAddress());
            //server.close();
   ...
   public static void main(String[] args) {
	  ...
	  try {
         Thread t = new DropBoxServer(port);
         t.start();
      }catch(IOException e) {
         e.printStackTrace();
      }
